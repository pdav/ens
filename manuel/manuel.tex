...
La primitive \texttt {chown} change le propriétaire et
...
int truncate (const char *nom, off_t lg)
...
\separation
\primitive {printf, fprintf, fprintf, sprintf, snprintf} --- écriture formattée
    \index{\texttt {printf}}
    \index{\texttt {dprintf}}
    \index{\texttt {fprintf}}
    \index{\texttt {sprintf}}
...
\begin {itemize}
	...
	\begin {quote}
	\begin {tabular} {|c|l|} \hline
	    \verb|l| & l'argument est de type \texttt {long}
		\\ \hline
	    \verb|ll| & l'argument est de type \texttt {long long}
		\\ \hline
...
La fonction \texttt {getcwd} calcule le nom du répertoire courant et le
