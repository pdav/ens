...
Les primitives {\tt stat}, {\tt lstat} et {\tt fstat} lisent la partie système d'un
...
Lorsque le fichier est un lien symbolique, {\tt stat} renvoie des
informations sur la cible du lien, alors que {\tt lstat} renvoie des
