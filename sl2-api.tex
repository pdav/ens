...
\begin {frame} {Rappels -- Processus}
    ...
    \begin {quote}
	Un processus peut être défini comme une instance d'un programme
...
\begin {frame} {Rappels}
    ...
    \begin {center}
	\includegraphics [width=.9\textwidth] {\inc/ps-state}
    \end {center}
...
\begin {frame} {Rappels -- Processus}
    \begin {center}
	\includegraphics [width=\textwidth] {\inc/ps-def}
    \end {center}
\end {frame}
...
\begin {frame} {Rappels -- Commutation de processus}
    ...
    \begin {center}
	\includegraphics [width=.85\textwidth] {\inc/ps-commut}
    \end {center}
...
\begin {frame} {Rappels -- Adressage logique}
	...
	\includegraphics [width=\textwidth] {\inc/ps-mem}
    \end {minipage}
\end {frame}
...
\begin {frame} {Rappels -- Adressage physique}
    ...
    \hfill
    \begin {minipage} {.43\textwidth}
	\includegraphics [width=\textwidth] {\inc/trans-adr}
    \end {minipage}
\end {frame}
...
\begin {frame} {Rappels -- Traduction d'adresses}
    ...
    \begin {center}
	\includegraphics [width=.7\textwidth] {\inc/mmu-princ}
    \end {center}
...
\begin {frame} {Rappels -- Traduction d'adresses}
	...
	\includegraphics [width=\textwidth] {\inc/ps-commut}
	\\
...
\begin {frame} {Rappels -- Traduction d'adresses}
    ...
    \begin {center}
	\includegraphics [width=.5\textwidth] {\inc/mmu-ipc}
    \end {center}
...
\begin {frame} {Rappels -- Traduction d'adresses}
    ...
    \begin {center}
	\includegraphics [width=.45\textwidth] {\inc/mmu-pdp11a}
    \end {center}
...
\begin {frame} {Rappels -- Traduction d'adresses}
    ...
    \begin {center}
	\includegraphics [width=.45\textwidth] {\inc/mmu-pdp11b}
    \end {center}
...
\begin {frame} {Rappels -- Mémoire virtuelle}
    ...
    \begin {center}
	\includegraphics [width=.75\textwidth] {\inc/mmu-i386}
    \end {center}
\end {frame}
...
\begin {frame} {Rappels -- Mémoire virtuelle}
    ...
    \begin {center}
	\includegraphics [width=.8\textwidth] {\inc/mmu-tlb386}
    \end {center}
...
\begin {frame} {Files de messages}
    ...
    \begin {center}
	\includegraphics [width=.9\textwidth] {\inc/msg}
    \end {center}
...
\begin {frame} {Files de messages}
    \begin {center}
	\includegraphics [width=.6\textwidth] {\inc/msg}
    \end {center}
...
\begin {frame} {Mémoire partagée}
    ...
    \begin {center}
	\includegraphics [width=.6\textwidth] {\inc/shmat}
    \end {center}
...
\begin {frame} {Threads}
    \begin {center}
	\includegraphics [width=.6\textwidth] {\inc/thr-intro}
    \end {center}
...
\begin {frame} {Threads}
	...
	\includegraphics [width=\textwidth] {\inc/thr-stack}
    \end {minipage}
...
\begin {frame} {Threads}
    ...
    \begin {center}
	\includegraphics [width=.9\textwidth] {\inc/thr-api}
    \end {center}
\end {frame}
...
\begin {frame} {Threads et signaux}
    \begin {center}
	\includegraphics [width=.9\textwidth] {\inc/thr-sig}
    \end {center}
...
\begin {frame} {Barrières}
    ...
    \begin {center}
	\includegraphics [width=.6\textwidth] {\inc/bar-intro}
    \end {center}
