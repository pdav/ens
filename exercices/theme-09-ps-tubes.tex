...
Écrivez un programme composé de deux processus~: le fils lit des
données sur l'entrée standard et les passe par un {\em tube} au père
qui les affiche sur sa sortie standard puis attend la terminaison
du fils.
