...
\begin {frame} {Variable critique}
	...
	\rc \textbf {Proc} & \textbf {Instruction}
	    & \textbf {\texttt {r0}$_A$}
	    & \textbf {\texttt {r0}$_B$}
	    & \textbf {Mém 1000}
	    \\
	\rc \multicolumn {2} {|l|} {initialement} &  ?  &  ?  & 200 \\
	\rc A & \texttt {mov r0,1000} & 200 &  ?  & 200 \\
	\rc B & \texttt {mov r0,1000} & 200 & 200 & 200 \\
	\rc A & \texttt {add r0,50}   & 250 & 200 & 200 \\
	\rc B & \texttt {add r0,10}   & 250 & 210 & 200 \\
	\rc A & \texttt {mov 1000,r0} & 250 & 210 & 250 \\
	\rc B & \texttt {mov 1000,r0} & 250 & 210 & 210 \\
    }
...
\begin {frame} {Section critique -- Sans support matériel}
	...
	\rc \textbf {Proc} & \textbf {Instruction}
	    ...
	    & \textbf {Mém 1000}
	    \\
	\rc \multicolumn {2} {|l|} {initialement} & ? & ? & 0 \\
	\rc A & \texttt {mov r0,(r1)} & 0 & ? & 0 \\
	\rc B & \texttt {mov r0,(r1)} & 0 & 0 & 0 \\
	\rc A & \texttt {tst r0}      & 0 & 0 & 0 \\
	\rc B & \texttt {tst r0}      & 0 & 0 & 0 \\
	\rc A & \texttt {mov r0,1}    & 1 & 0 & 0 \\
	\rc B & \texttt {mov r0,1}    & 1 & 1 & 0 \\
	\rc A & \texttt {mov (r1),r0} & 1 & 1 & 1 \\
	\rc B & \texttt {mov (r1),r0} & 1 & 1 & 1 \\
    }
...
\begin {frame} {Section critique -- Avec support matériel}
	...
	\rc \textbf {Proc} & \textbf {Instruction}
	    ...
	    \\
	\rc \multicolumn {2} {|l|} {initialement} & ? & ? & 0 \\
	\rc A & \texttt {mov r0,1}    & 1 & ? & 0 \\
	\rc B & \texttt {mov r0,1}    & 1 & 1 & 0 \\
	\rc B & \texttt {fas (r1),r0} & \textbf {0} & 0 & \textbf {1} \\
	\rc B & \texttt {fas (r1),r0} & 0 & \textbf {1} & \textbf {1} \\
	\rc A & \texttt {tst r0}      & 0 & 1 & 1 \\
	\rc B & \texttt {tst r0}      & 0 & 1 & 1 \\
	\rc A & \texttt {rtn}         & 0 & 1 & 1 \\
	\rc B & \texttt {jnz ...}     & 0 & 1 & 1 \\
    }
