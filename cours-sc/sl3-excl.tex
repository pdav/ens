...
\begin {frame} {Variable critique}
	...
	\rca \textbf {Proc} & \textbf {Instruction}
	    & \textbf {\texttt {r0}$_A$}
	    & \textbf {\texttt {r0}$_B$}
	    & \textbf {Mém 1000}
	    \\
	\rcb \multicolumn {2} {|l|} {initialement} &  ?  &  ?  & 200 \\
	\rca A & \texttt {mov r0,1000} & 200 &  ?  & 200 \\
	\rcb B & \texttt {mov r0,1000} & 200 & 200 & 200 \\
	\rca A & \texttt {add r0,50}   & 250 & 200 & 200 \\
	\rcb B & \texttt {add r0,10}   & 250 & 210 & 200 \\
	\rca A & \texttt {mov 1000,r0} & 250 & 210 & 250 \\
	\rcb B & \texttt {mov 1000,r0} & 250 & 210 & 210 \\
    }
...
\begin {frame} {Section critique -- Sans support matériel}
	...
	\rca \textbf {Proc} & \textbf {Instruction}
	    ...
	    & \textbf {Mém 1000}
	    \\
	\rcb \multicolumn {2} {|l|} {initialement} & ? & ? & 0 \\
	\rca A & \texttt {mov r0,(r1)} & 0 & ? & 0 \\
	\rcb B & \texttt {mov r0,(r1)} & 0 & 0 & 0 \\
	\rca A & \texttt {tst r0}      & 0 & 0 & 0 \\
	\rcb B & \texttt {tst r0}      & 0 & 0 & 0 \\
	\rca A & \texttt {mov r0,1}    & 1 & 0 & 0 \\
	\rcb B & \texttt {mov r0,1}    & 1 & 1 & 0 \\
	\rca A & \texttt {mov (r1),r0} & 1 & 1 & 1 \\
	\rcb B & \texttt {mov (r1),r0} & 1 & 1 & 1 \\
    }
...
\begin {frame} {Section critique -- Avec support matériel}
	...
	\rca \textbf {Proc} & \textbf {Instruction}
	    ...
	    \\
	\rcb \multicolumn {2} {|l|} {initialement} & ? & ? & 0 \\
	\rca A & \texttt {mov r0,1}    & 1 & ? & 0 \\
	\rcb B & \texttt {mov r0,1}    & 1 & 1 & 0 \\
	\rca B & \texttt {fas (r1),r0} & \textbf {0} & 0 & \textbf {1} \\
	\rcb B & \texttt {fas (r1),r0} & 0 & \textbf {1} & \textbf {1} \\
	\rca A & \texttt {tst r0}      & 0 & 1 & 1 \\
	\rcb B & \texttt {tst r0}      & 0 & 1 & 1 \\
	\rca A & \texttt {rtn}         & 0 & 1 & 1 \\
	\rcb B & \texttt {jnz ...}     & 0 & 1 & 1 \\
    }
